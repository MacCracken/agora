...
> **Last refresh**: 2026-05-23 (v0.1.0 — initial scaffold + doc-tree adoption per first-party-documentation.md) | **Refresh cadence**: when docs are touched, update the affected row.
...
| `CHANGELOG.md` | 2026-05-23 | ✅ Fresh | **Source of truth per CLAUDE.md.** v0.1.0 scaffold entry only. |
...
| File | Last touched | Status | Action |
|---|---|---|---|
| `state.md` | 2026-05-23 | ✅ Fresh | **Rotates every release.** v0.1.0 snapshot — version, binary size, in-flight slot (M1), gate state for M2–M6 deps. |
