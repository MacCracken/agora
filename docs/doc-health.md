...
| `VERSION` | 2026-06-08 | ✅ Fresh | `1.3.5`. Bumped via release flow. |
...
| File | Last touched | Status | Action |
|---|---|---|---|
| `state.md` | 2026-06-08 | ✅ Fresh | **Rotates every release.** **1.3.5 CUT** — Casino integrations (188 tests; 812,528 B; pin 6.1.15). Refresh line / Released / Toolchain / Build-artifacts / Tests / In-flight (Casino-integrations summary + 1.3.6 Training sim next) / Recent-shipped rows synced. |
| `roadmap.md` | 2026-06-08 | ✅ Fresh | Release table: **1.3.5 ✅ Casino integrations** (wager across PA/Smuggler/QUEST); **1.3.4 ✅ Wager** ([ADR 0013](adr/0013-wagering-module-rng-fairness.md), Accepted); planned **1.3.6 training sim → 1.3.7 war-game ([ADR 0014](adr/0014-async-shared-world-strategy.md)) → 1.4.0 Descent link**. "In progress" → 1.3.6 next; the *Planned* § carries the 1.3.4–1.3.7 design blurb. |
...
15 ADRs (0001-0013 + 0015 Accepted; 0014 Proposed for the 1.3.7 work). Re-read pass per minor closeout; ADRs document decisions, not status.
