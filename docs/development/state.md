...
- `src/handler.cyr` — **1.1.0** The Handler: agents/cities + cable generation + solvable-mole deduction + daily loop + dispatch actions + standings + feed/render + save (header `THDG1`)
