...
| **1.3.2** | **QUEST build-out** — the LORD-homage door ("Quest of the Undying Emerald Sovereign Throne", `play quest`): the twelve-level **Great-Work** arc (Nigredo→Albedo→Citrinitas→Rubedo) + the **Emerald-Tablet** fragment spine, on the existing pure-module door + daily-turn + async-PvP machinery. Full design in [`roadmap-future.md`](roadmap-future.md) § Door games. | 📋 planned |
...
**1.3.2 QUEST — next.** The LORD-homage door ("Quest of the Undying Emerald Sovereign Throne", `play quest`): the twelve-level Great-Work arc + the Emerald-Tablet fragment spine, on the existing pure-module door + daily-turn + async-PvP machinery. Full design in [`roadmap-future.md`](roadmap-future.md) § Door games. After it: **1.3.3 Jabberwacky** (the first corpus-learning bot). See the release table + *Planned* below.
